...
Original file is located at
    https://colab.research.google.com/drive/1BmKXscPUCkAZ_WgQmUfrB3j93KHKkJvy
"""
...
data=pd.Series([2,4,6,8,10,12,14,16,18])

print(data)

data=pd.series([1,2,3,4,5,6,7],index=['a','b','c','d'])



print ('hello world')

print ('hello cahmpion')

print ('hello world how are you')

print ('where are you')
print ('who is the king')

apples = 20
mangoes=30
print(f'we bought {apples} apples and {mangoes} mangoes')

sachin=200
kohli=100
print (f' they scored {sachin} sachin and {kohli} kohli')

laptops = 40
mobiles =30
tvs =26
bikes=70
print (f' that company sold {laptops} laptops with offer {mobiles} mobiles in glass {tvs} tvs on discount and {bikes} bikes with registration')
...
squarekm=25
established=2000
print(f'a vilage {established} established in the year with population {population} population of where {females} females of and {males} {males} of in the number of {homes} homes that area is in {squarekm} square km of')
...
avgattendence=90
rollnumbers=2001-1
print(f'a school have {students} students and number of {boys} boys and {girls} girls for teacing there are staff 0f {teachers} teachers with {fee} fee of and {avgattendence} avgattendence for student is percentage and {rollnumbers} rollnumbers starting from')

print ('singh is king')
print ('india is my country where our indians feel very proud of our country')
...
in python what every writer in single '' or double "" is considered as a string
"""
...
print(30+30-30)
print(200*20+400/10)
print((5000-400/200) *(300-150))
print((200-3000/300-400+490*500)*(300+9))
...
print (f' in super market i have bought 20 {apples} apples 30 {bananas} bananas 40 {mangoes} mangoes')



"""
'''
list is a type of variable which can handle various multiple inputs
'''
"""

c1= [1,2,3,4,5,6]
c2=['king','queen','bob','dog']
c3=[1,2,'queen','king',5,8,]
...
"""'''
create a list with three words and four numbers
'''
"""

mylist=[1,2,3,8,'queen','bob','dog']
print(mylist)

''' execute each question in a cell

1. print a string 'dog kills  a cat"
2.assign a variable to your name and print " my name is?'
3.calculate 5+14-6*2
...
thislist=[1,2,3,4,5,'apple','mango','banana']
print(len(thislist))

cityname = 'hyderabad'
print(f'iam leaving in {cityname}')

area ='chennai'
print(f' im going to {area}')

colony='rtc'
town='shadnagar'
print(f'im living in {colony} area of {town}')

place = 'mumbai'
country ='india'
language ='marathi'
print (f' we are the people of {place} in the {country} where we spoke the {language}')



"""## for loop"""

l1 = ['ajay','manikanta','manish','vamshi']
for i in l1:
   print (i)

l2 =['akshay','arjun','kiran','mahesh']
for k in l2:
   print (k)
...
l2 =["he","scored","a","century"]
sentence = " "
for i in l2:
  sentence = sentence + " " + i
  print(sentence)

l3 =["he","built","a","home","in","hyderbad"]
sentence = " "
for f in l3:
  sentence = sentence + " " + f
  print(sentence)
...
city = 'chennai'
print (f' we are going to {city}');
are

area = 'hyderbad'
print (f' they live in the city called {area}')

l1 = ['mahesh','arjun','pawan','prabhas']
for i in l1:
  print (i)
...
"""day 4 class by ajay ### INDENTATION
...
l3 = [3,7,11,13,17,23,29,31,37,38,40,45]
for i in l3:
  if(i%2 ==0):
    print(i)
  else:
...
l2 = [[2,3,4,6,8,9],[1,5,9]]
for i in l2:
  print(i)
  if (j % 2 ==0):
    print(j)

a_mul = np.arr([[1,2,3,4],
                 [4,5,6,7],
                 [8,4,5,6]])
print(a_mul.shape)
...
a= np.array([{2,3,4,5},{5,6,7,8},{9,10,11,12}])
...
"""CREATE RANDOM VALUES FROM A NORMAL DISTRIBUTION ## MEAN DEVIATION

IF YOU WANT TO CREATE A RANDOM INTEGERS #STARTVALUES,ENDVLUE,SHAPE # EXCEPTION
"""
...
x1 = np.random.randint(1,2,size=(4,4))
...
x3 = np.random.randint(30,size=(3,5,6))
...
l1[:2]+l1[1:2]  ##rowposition column position
...
import pandas as pd
df=pd.read_csv('president_heights (4).csv')
...
heights[heights >180].mean()

heights[(heights > 180)&(heights < 185)].mean()
...
##pandas ia a frame work we can do evry wori=k in the excel
...
data = pd.Series([0,0,25,0],index=['a','b','c','d'])
...
a= np.random.randint(0,20,size=6)
...
population={'AP':1000,'TS':2000,'KA':3000,'TN':4000}

population

import pandas as pd
b=pd.Series(population)
...
## anything other than int or float are called "datatype=object"
...
##  create a data frame with 5 friends name as index and 3 columns with math,social,scinece
##  access the second row with iloc and loc
##  acess rows 3 and columns 4 along with columns 2

marks=pd.DataFrame[{"mathmmarks":['10','20','30','40','50'],{sciencemarks:['']}]

import pandas as pd

area=pd.Series    ###df.dropna(axis='columns') will delete rows and columns wich have a single Nan value
                  ## if nan values are greater than it will show the valuees
                  ##data.fillna(0) will fill the all nan values into 0
                  ##fillna. forwrad filling'nfill' and backward filling ''bfill'
                  ##each index is a tuple
                  ##fromproduct is a optimized product of data

## hierarchial indexing

##unstacking is trying to remove multiple  indexes   and stacking of the data is arranging the values of data.

pd.Series(populations,index=index)

index=[[2013,2014]],[1,2],[3,5]
index=pd.multiindex.from_product(index,names=['year','visit','room number'])
print(index)
...
python is a programming language used for the various purposes to develop the web application, and analysis of data.
numpy is a numerical python used for the combination of numerical values and the python programming.
arrays and lists are used for the arranging the set of values i